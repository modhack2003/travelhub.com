...
function Navbar() {
  ...
  return (
    <header className={`w-full bg-transparent absolute flex flex-col md:flex-row justify-between items-center md:px-48 px-0 py-6  font-Poppins z-50 `}> {/* Set z-50 to ensure the header is on top */}
